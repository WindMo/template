...
jQuery(function($) {
	...
	var available_functions = {
		...
		'sidebar_scrollable' : {
							 ...
							 'scroll_to_active': true, //scroll to selected item? (one interval only on page load)
							 ...
							 'smooth_scroll': 200, //> 0 means smooth_scroll, interval in ms, used in first approach only, better to be almost the same amount as submenu transition interval
